...
(function (factory) {
    ...
    class CircleDrawer {
        async draw(data) {
            const { drawCircle } = await (__syncRequire ? Promise.resolve().then(() => __importStar(require("./Utils.js"))) : new Promise((resolve_1, reject_1) => { require(["./Utils.js"], resolve_1, reject_1); }).then(__importStar));
            drawCircle(data);
        }
        getSidesCount() {
            return sides;
